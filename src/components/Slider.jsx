    ...
    <div>
      ...
      <div className="absolute right-4 sm:right-12 flex flex-col items-center justify-center top-[30%] text-balance space-y-4 ">
        ...
        <Link to={"/products"}>
          <button
            type="button"
            className="px-4 py-2 mt-4 text-white transition-all duration-300 ease-in-out bg-indigo-800 rounded-md shadow-md cursor-pointer hover:bg-black ring-1 ring-slate-100 hover:outline-none focus:outline-none"
          >
            Shop Now
            <span>
